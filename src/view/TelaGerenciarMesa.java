...
public class TelaGerenciarMesa extends javax.swing.JFrame {
    ...
    ProdutosArquivoDAO produtos = new ProdutosArquivoDAO();
    PedidosArquivoDAO pedido = new PedidosArquivoDAO();
    ...
    private void initComponents() {
        ...
        NumeroDaMesa.setModel(new javax.swing.SpinnerNumberModel(1, 1, null, 1));
    ...
    private void NovaComandaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_NovaComandaActionPerformed
        ...
        if (GerenciaMesa.novaComanda((Integer) NumeroDaMesa.getValue())) {
            JOptionPane.showMessageDialog(null, "Comanda criada com sucesso para a mesa:  " + NumeroDaMesa.getValue());
    ...
    private void jButtonVerPedidosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonVerPedidosActionPerformed
        try {
            if (pedido.listar().isEmpty()) {
                JOptionPane.showMessageDialog(null, "Não foram feitos nenhum pedido!");
            } else {
    ...
    private void jButtonEncerrarComandaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonEncerrarComandaActionPerformed
        ...
        try {
            ...
            if (pedido.MesasAtendidas(numero) == false || pedido.listar().isEmpty()) {
                JOptionPane.showMessageDialog(null, "Não há modificação!");
            } else {
                ComandasArquivoDAO dao = new ComandasArquivoDAO();
                dao.montarComanda(numero);

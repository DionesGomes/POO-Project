...
public class TelaCadastroProdutos extends javax.swing.JFrame {
     ...
     */
    ProdutosArquivoDAO cad = new ProdutosArquivoDAO();
    ...
    private void verificaCampo() throws FormularioException {
        if (codigo.getText().equals("")) {
            throw new FormularioException("O compo Código não pode estar vazio!");
        }
        if (nome.getText().equals("")) {
            throw new FormularioException("O compo Nome não pode estar vazio!");
        }
        if (descricao.getText().equals("")) {
            throw new FormularioException("O compo Descrição não pode estar vazio!");
        }
        if (preco.getText().equals("")) {
            throw new FormularioException("O compo Preco não pode estar vazio!");
        }

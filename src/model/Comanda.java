...
public class Comanda implements Serializable {
    ...
    public Comanda(List<Pedido> comanda, LocalDate data, int numeroComanda, int mesa) {
    ...
    public String toString() {
        return "Comanda{" + "comanda=" + comanda + ", data=" + data + ", numeroComanda=" + numeroComanda + ", mesa=" + mesa + '}';
    }
